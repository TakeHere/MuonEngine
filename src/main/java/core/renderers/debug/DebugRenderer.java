...
public class DebugRenderer {
    ...
    private void prepareInstance(DebugSphere sphere){
        Matrix4f transformationMatrix = Matrixes.createTransformationMatrix(sphere.getPosition().toJomlVector(), Vector3.ZERO.toJomlVector(), new Vector3f(sphere.getScale(), sphere.getScale(), sphere.getScale()));
